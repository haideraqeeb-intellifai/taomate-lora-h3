...
def main():
    ...
    report = {
        ...
        "base_model": "MiniMax H3 FL2VA full BF16 (non-pruned, non-quantized)",
        "text_encoder": "Qwen3-VL 32B BF16 (non-quantized)",
        "adapter": "Robert1212star/TaoMate-H3-3Step-ComfyUI",
        "attention": "PyTorch scaled dot-product attention",
        "sampler": "Euler", "scheduler": "simple",
        "sigma_shift_video": 12.0, "sigma_shift_audio": 3.0,
        "optimizations_excluded": ["SageAttention", "INT8/FP8/NVFP4 model quantization", "VSA", "Spectrum", "EasyCache", "graph compilation"],
        "memory_management": "Dynamic CPU/GPU weight offloading required to fit the full BF16 model on 32 GB VRAM",
        "comfy_commit": COMFY_COMMIT,
        "runner_sha256": hashlib.sha256(Path(__file__).read_bytes()).hexdigest(),
        "prompt_sha256": hashlib.sha256(prompt.encode()).hexdigest(),
        "artifact_sha256": {
            MODELS["diffusion"]: "907d4add438438ec1544f5240c3b38532ed934fe6be75677a6bbda2a6fdd6182",
            MODELS["text"]: "600d567f6a9629c8574e8e7041b199bdd9c59a986afa7906910a81919610607d",
